...
AuroDatePicker.register("auro-datepicker-dev");
AuroDropdown.register("auro-dropdown-dev");
AuroSelect.register("auro-select-dev");
AuroInput.register("auro-input-dev");
...
<div class="space-y-8">
	...
	<BackgroundContainer showBoth >
		<auro-button ondark={true} shape="pill">Pill</auro-button>
		<auro-button ondark={true} shape="rounded">Rounded</auro-button>
	...
	<auro-header level="5" display="300" >Classic</auro-header>
	<BackgroundContainer showBoth class="flex flex-row gap-4">
		<auro-datepicker-dev ondark={true} style="width: 306px" placeholder="MM/DD">
		...
		<auro-datepicker-dev ondark={true} range style="width: 400px" placeholder="MM/DD">
			<span slot="bib.fullscreen.headline">Datepicker Headline</span>
			<span slot="fromLabel">Choose a date</span>
			<span slot="bib.fullscreen.dateLabel">Choose a date</span>
			<span slot="helptext">helptext content</span>
	...
	<auro-header level="5" display="300" margin="both" size="none">Snowflake</auro-header>
	...
	<BackgroundContainer background="dark" class="flex flex-row gap-4">
		<auro-datepicker-dev ondark={true} style="width: 306px" layout="snowflake" shape="snowflake" placeholder="MM/DD">
			<span slot="bib.fullscreen.headline">Datepicker Headline</span>
			<span slot="fromLabel">Choose a date</span>
			<span slot="bib.fullscreen.dateLabel">Choose a date</span>
			<span slot="helptext">helptext content</span>
		...
		<auro-datepicker-dev ondark={true} range style="width: 400px" layout="snowflake" shape="snowflake" placeholder="MM/DD">
			<span slot="bib.fullscreen.headline">Datepicker Headline</span>
			<span slot="fromLabel">Choose a date</span>
			<span slot="bib.fullscreen.dateLabel">Choose a date</span>
			<span slot="helptext">helptext content</span>
	...
	<auro-header level="5" display="300">Classic</auro-header>
	<BackgroundContainer showBoth>
		<auro-counter-group-dev ondark={true} isDropdown>
			<div slot="bib.fullscreen.headline">Passengers</div>
			<div slot="label">Passengers</div>
			<span slot="helpText">helpText content</span>
			<span slot="valueText">valueText content</span>
			<auro-counter-dev>
				Adults
	...
	<BackgroundContainer showBoth>
		<auro-counter-group-dev ondark={true} isDropdown layout="snowflake">
			<div slot="bib.fullscreen.headline">Passengers</div>
			<div slot="label">Passengers</div>
			<span slot="helpText">helpText content</span>
			<span slot="valueText">valueText content</span>
	...
	<auro-header level="5" display="300">Classic</auro-header>
	<BackgroundContainer showBoth >
		<auro-dropdown-dev ondark={true} aria-label="custom label" style="width: 249px;">
			<span slot="label">Dropdown label</span>
			<span slot="helpText">helpText content</span>
			<span slot="trigger">Trigger content</span>
			<div class="p-5">
				<auro-header level="5" display="300">
					Lorem ipsum solar
				</auro-header>
			</div>
		</auro-dropdown-dev>
	...
	<auro-header level="5" display="300">Snowflake</auro-header>
	<BackgroundContainer showBoth >
		<auro-dropdown-dev ondark={true} aria-label="custom label" shape="snowflake" size="lg" layout="snowflake" style="width: 249px;">
			<span slot="label">Dropdown label</span>
			<span slot="helpText">helpText content</span>
			<span slot="trigger">Trigger content</span>
			<div class="p-5">
	...
	<BackgroundContainer showBoth class="flex flex-row gap-4">
		...
		<auro-dropdown-dev ondark={true} aria-label="custom label" shape="pill-left" size="xl" layout="emphasized" style="width: 249px;">
			<span slot="label">Dropdown label</span>
			<span slot="helpText">helpText content</span>
			<span slot="trigger">Trigger content</span>
			<div class="p-5">
		...
		<auro-dropdown-dev ondark={true} aria-label="custom label" shape="pill-right" size="xl" layout="emphasized" style="width: 249px;">
			<span slot="label">Dropdown label</span>
			<span slot="helpText">helpText content</span>
			<span slot="trigger">Trigger content</span>
			<div class="p-5">
	...
	<auro-header level="5" display="300">Snowflake</auro-header>
	<BackgroundContainer showBoth class="flex flex-row gap-4">
		<auro-select-dev required ondark={true} layout="snowflake" shape="snowflake" value="flights" forceDisplayValue style="display:inline-block;">
			<span slot="bib.fullscreen.headline">Bib Headline</span>
			<span slot="label">Select label</span>
			<span slot="helptext">helptext content</span>
			<span slot="placeholder">Placeholder content</span>
		...
		<auro-select-dev required ondark={true} layout="snowflake" shape="snowflake" value="flights" style="display:inline-block;">
			<span slot="bib.fullscreen.headline">Bib Headline</span>
			<span slot="label">Select label</span>
			<span slot="helptext">helptext content</span>
			<span slot="placeholder">Placeholder content</span>
	...
	<BackgroundContainer showBoth class="flex flex-row gap-4">
		...
		<auro-select-dev required ondark={true} layout="emphasized" shape="pill" size="xl" value="flights" style="display:inline-block;">
			<span slot="bib.fullscreen.headline">Bib Headline</span>
			<span slot="label">Select label</span>
			<span slot="helptext">helptext content</span>
			<span slot="placeholder">Placeholder content</span>
	...
	<auro-header level="5" display="300">Classic</auro-header>
	<BackgroundContainer showBoth class="flex flex-row gap-4">
	<auro-combobox-dev ondark={true} placeholder="Placeholder content" required style="width: 300px;">
     	<span slot="bib.fullscreen.headline">Bib Headline</span>
	...
	<auro-header level="5" display="300">Snowflake</auro-header>
	<BackgroundContainer showBoth class="flex flex-row gap-4">
	<auro-combobox-dev ondark={true} layout="snowflake" shape="snowflake" size="xl" placeholder="Placeholder content" required style="width: 300px;">
      	<span slot="bib.fullscreen.headline">Bib Headline</span>
		<span slot="label">Name</span>
		<span slot="helpText">helpText content</span>
      <auro-menu-dev>
  ...
  <auro-header level="5" display="300">Emphasized</auro-header>
	<BackgroundContainer showBoth class="flex flex-row gap-4">
		...
		<auro-combobox-dev ondark={true} layout="emphasized" shape="pill-left" size="xl" placeholder="Placeholder content" required style="width: 300px;">
			<span slot="bib.fullscreen.headline">Bib Headline</span>
			<span slot="label">Name</span>
			<span slot="helpText">helpText content</span>
			<auro-menu-dev>
		...
		<auro-combobox-dev ondark={true} layout="emphasized" shape="pill-right" size="xl" placeholder="Placeholder content" required style="width: 300px;">
			<span slot="bib.fullscreen.headline">Bib Headline</span>
			<span slot="label">Name</span>
			<span slot="helpText">helpText content</span>
			<auro-menu-dev>
	...
	<auro-header level="5" display="300">Classic</auro-header>
	<BackgroundContainer showBoth>
		<auro-input-dev ondark={true} placeholder="Departure" style="width: 249px;" required>
	...
	<BackgroundContainer showBoth class="flex flex-row gap-4">
		<auro-input-dev ondark={true} id="beta" layout="snowflake" shape="snowflake" size="xl" placeholder="Departure" style="width: 249px;" required>
			<label slot="label">From</label>
			<span slot="helptext">helptext content</span>
		</auro-input-dev>
	</BackgroundContainer>
	...
	<BackgroundContainer showBoth class="flex flex-row gap-4">
		<auro-input-dev ondark={true} id="beta" layout="emphasized" shape="pill" size="xl" placeholder="Departure" style="width: 249px;" required>
			...
			<auro-input-dev id="charlie" layout="emphasized-left" shape="pill-left" size="xl" placeholder="Departure" style="width: 249px;" required>
			<label slot="label">From</label>
			<span slot="helptext">helptext content</span>
		</auro-input-dev>

		<auro-input-dev ondark={true} id="delta" layout="emphasized-right" shape="pill-right" size="xl" placeholder="Departure" style="width: 249px;" required>
			<label slot="label">From</label>
			<span slot="helptext">helptext content</span>
		</auro-input-dev>
	</BackgroundContainer>
