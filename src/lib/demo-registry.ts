...
export const demoRegistry: Demo[] = Object.entries(demoImports).map(
	([path, importFn]) => {
		...
		return {
			...
			importPath: path,
			loader: importFn as () => Promise<unknown>,
		};
	},
);
